...
const Inventory_home = () => {
  ...
  const handleDownloadCSV = () => {
    ...
    const csvData = [
      ["Virtual Vogue - Inventory management Report"],
      ["                                                  "],
      ...
      ["All Rights Reserved - Virtual Vogue"],
    ];
  ...
  const handleDownloadPDF = async () => {
    ...
    page.drawText("Virtual Vogue (pvt) Ltd", {
      x: 230,
      y,
      size: 18,
      color: rgb(1, 0, 0),
    ...
    page.drawText("All Rights Reserved - Virtual Vogue", {
      x,
      y,
      size: fontSize,
    });
